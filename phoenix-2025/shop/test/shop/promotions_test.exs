defmodule Shop.PromotionsTest do
  ...
  describe "promotions" do
    ...
    test "create_promotion/1 with valid data creates a promotion" do
      valid_attrs = %{code: "some code", name: "some name", expires_at: ~U[2025-06-23 04:39:00Z]}
      ...
      assert promotion.expires_at == ~U[2025-06-23 04:39:00Z]
    end
    ...
    test "update_promotion/2 with valid data updates the promotion" do
      promotion = promotion_fixture()
      update_attrs = %{code: "some updated code", name: "some updated name", expires_at: ~U[2025-06-24 04:39:00Z]}
      ...
      assert promotion.expires_at == ~U[2025-06-24 04:39:00Z]
    end
